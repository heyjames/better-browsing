...
let script = ""; document.querySelectorAll("yt-formatted-string[class='segment-text style-scope ytd-transcript-segment-renderer']").forEach(e => (script = script + ` ${e.textContent}`)); console.log(script.trim());
